...
import { faBook, faGauge, faSearch, faSignOutAlt, faUser, faUserGroup, faCalendarAlt, faFileLines, faChalkboardTeacher } from "@fortawesome/free-solid-svg-icons";
...
export const AppLayout = () => {
    ...
    const navigateItems = [
        ...
        { name: 'Mentor Availability', icon: <FontAwesomeIcon className="mr-2" icon={faCalendarAlt} />, path: URL_ROUTES.MENTOR_AVAILABILITY, roles: ['Mentor'] },
        { name: 'Find Courses', icon: <FontAwesomeIcon className="mr-2" icon={faSearch} />, path: URL_ROUTES.TRAINEE_COURSES, roles: ['Trainee'] },
        { name: 'My Courses', icon: <FontAwesomeIcon className="mr-2" icon={faBook} />, path: URL_ROUTES.TRAINEE_MY_COURSES, roles: ['Trainee'] },
        { name: 'All Courses', icon: <FontAwesomeIcon className="mr-2" icon={faBook} />, path: URL_ROUTES.All_COURSES, roles: ['Admin'] },
        { name: 'Find Mentor', icon: <FontAwesomeIcon className="mr-2" icon={faChalkboardTeacher} />, path: URL_ROUTES.FIND_MENTOR, roles: ['Trainee']},
        ...
        { name: 'Sessions', icon: <FontAwesomeIcon className="mr-2" icon={faCalendarAlt} />, path: URL_ROUTES.SESSION, roles: ['Mentor', 'Trainee'] },
