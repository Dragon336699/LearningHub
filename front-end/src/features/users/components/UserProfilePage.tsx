import { ChevronLeft, Star, Calendar, Clock, CreditCard, MessageSquare } from "lucide-react";
        ...
        <section>
          ...
          <div className="flex flex-col gap-3">
            {user.experiences && user.experiences.length > 0 ? (
              ...
              <p className="text-sm text-slate-400">No work experience information available.</p>
            )}
          </div>
        </section>
      </div>
