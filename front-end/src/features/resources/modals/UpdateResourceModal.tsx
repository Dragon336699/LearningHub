...
import { UpdateResourceForm, UpdateResourceSchema } from "../schemas/UpdateResourceSchema";
...
type UpdateResourceModalProps = {
    data: Resource;
    isLoading: boolean;
    onSubmit: (data: UpdateResourceForm) => void;
    onClose: () => void;
};

export const UpdateResourceModal = ({ data, isLoading, onSubmit, onClose }: UpdateResourceModalProps) => {
    ...
    return (
        <DialogShell isLoading={isLoading} open={true} title="Edit Resource" onClose={onClose}>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex gap-4 justify-end mt-6">
                    <button type="button" className="cursor-pointer btn btn-secondary" onClick={onClose}>
                        Cancel
                    </button>
                    <button type="submit" disabled={!isValid || isLoading || !isDirty} className="cursor-pointer btn btn-primary">
