...
namespace LearningHub.Application.Interfaces.Services
{
    public interface ICourseService
    {
        ...
        Task<Result<PagedResult<CourseDto>>> GetPagedAllCourses(int page, int pageSize, string? keyword);
        Task<Result<PagedResult<CourseDto>>> GetCoursesByMentor(int page, int pageSize, string? keyword, Guid userId);
        Task<Result<PagedResult<CourseDto>>> GetPublishedCourses(int page, int pageSize, string? keyword);
        ...
        Task<Result<List<CourseTraineeDto>>> GetUsersNotEnrolledInCourseAsync(Guid courseId, string? keyword);
